      ...
      <Form onSubmit={handleSubmit}>
        ...
        <Form.Group>
          ...
          <Form.Control
            ...
            step='0.01'
            value={newf_mk}
            onChange={(event) => setNewf_mk(event.target.value)}
          />
        </Form.Group>
        ...
        <Form.Group>
          ...
          <Form.Control
            ...
            step='0.01'
            value={newf_t0k}
            onChange={(event) => setNewf_t0k(event.target.value)}
          />
        </Form.Group>
        <Form.Group>
          <Form.Label>
          ...
          <Form.Control
            ...
            step='0.01'
            value={newf_t90k}
            onChange={(event) => setNewf_t90k(event.target.value)}
          />
        </Form.Group>
        <Form.Group>
          <Form.Label>
          ...
          <Form.Control
            ...
            step='0.01'
            value={newf_c0k}
            onChange={(event) => setNewf_c0k(event.target.value)}
          />
        </Form.Group>
        <Form.Group>
          <Form.Label>
          ...
          <Form.Control
            ...
            step='0.01'
            value={newf_c90k}
            onChange={(event) => setNewf_c90k(event.target.value)}
          />
        </Form.Group>
        <Form.Group>
          <Form.Label>
          ...
          <Form.Control
            ...
            step='0.01'
            value={newE_0mean}
            onChange={(event) => setNewE_0mean(event.target.value)}
          />
        </Form.Group>
        <Form.Group>
          <Form.Label>
          ...
          <Form.Control
            ...
            step='0.01'
            value={newE_005}
            onChange={(event) => setNewE_005(event.target.value)}
          />
        </Form.Group>
        <Form.Group>
          <Form.Label>
          ...
          <Form.Control
            ...
            step='0.01'
            value={newE_90mean}
            onChange={(event) => setNewE_90mean(event.target.value)}
          />
        </Form.Group>
        <Form.Group>
          <Form.Label>
          ...
          <Form.Control
            ...
            step='0.01'
            value={newG_mean}
            onChange={(event) => setNewG_mean(event.target.value)}
          />
        </Form.Group>
        <Form.Group>
          <Form.Label>
          ...
          <Form.Control
            ...
            step='0.01'
            value={newG_005}
            onChange={(event) => setNewG_005(event.target.value)}
          />
        </Form.Group>
        <Form.Group>
          <Form.Label>
          ...
          <Form.Control
            ...
            step='0.01'
            value={newdensity_k}
            onChange={(event) => setNewdensity_k(event.target.value)}
          />
        </Form.Group>
        <Form.Group>
          <Form.Label>
          ...
          <Form.Control
            ...
            step='0.01'
            value={newdensity_mean}
            onChange={(event) => setNewdensity_mean(event.target.value)}
          />
        </Form.Group>
        <Form.Group>
          <Form.Label>&#x3BB;:</Form.Label>
          <Form.Control
            required
            type='number'
            step='0.01'
            value={newthermal_conductivity}
            onChange={(event) => setNewthermal_conductivity(event.target.value)}
          />
        </Form.Group>
