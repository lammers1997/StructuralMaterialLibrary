      ...
      <Form onSubmit={handleSubmit} style={{ width: "24rem" }}>
        ...
        <Form.Group>
          ...
          <Form.Control
            ...
            step='0.01'
            value={newf_ckcube}
            onChange={(event) => setNewf_ckcube(event.target.value)}
          />
        </Form.Group>
        <Form.Group>
          <Form.Label>
          ...
          <Form.Control
            ...
            step='0.01'
            value={newf_ctm}
            onChange={(event) => setNewf_ctm(event.target.value)}
          />
        </Form.Group>
        <Form.Group>
          <Form.Label>
          ...
          <Form.Control
            ...
            step='0.01'
            value={newfctk05}
            onChange={(event) => setNewfctk05(event.target.value)}
          />
        </Form.Group>
        <Form.Group>
          <Form.Label>
          ...
          <Form.Control
            ...
            step='0.01'
            value={newfctk95}
            onChange={(event) => setNewfctk95(event.target.value)}
          />
        </Form.Group>
        <Form.Group>
          <Form.Label>
          ...
          <Form.Control
            ...
            step='0.01'
            value={newEcm}
            onChange={(event) => setNewEcm(event.target.value)}
          />
        </Form.Group>
        <Form.Group>
          <Form.Label>
          ...
          <Form.Control
            ...
            step='0.01'
            value={newepsilon_c1}
            onChange={(event) => setNewepsilon_c1(event.target.value)}
          />
        </Form.Group>
        <Form.Group>
          <Form.Label>&#x3C1;:</Form.Label>
          <Form.Control
            required
            type='number'
            step='0.01'
        ...
        {/*<div style={{ display: "flex", flexDirection: "column" }}>
          ...
          <p>
            ...
            <input
              ...
              value={newthermal_conductivity}
              onChange={(event) =>
                setNewthermal_conductivity(event.target.value)
              }
            />
            W/(m*K)
          </p>
